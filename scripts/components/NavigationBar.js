export default class NavigationBar {
  constructor(
    ...
    this._activeTasks = this._navbar.querySelector(".todo-navbar__item_type_active");
    this._completeTasks = this._navbar.querySelector(".todo-navbar__item_type_complete");
    this._allTasks = this._navbar.querySelector(".todo-navbar__item_type_all");
    this._clearCompletedButton = this._navbar.querySelector(".todo-navbar__clear_type_completed");
